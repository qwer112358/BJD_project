...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->методРасчетаToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::методРасчетаToolStripMenuItem_Click);
			// 
...
private: System::Void методРасчетаToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
}
...
private: System::Void вычислитьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	double P = System::Double::Parse(this->toolStripTextBox1->Text);
	double L = System::Double::Parse(this->textBox1->Text);
	double B = System::Double::Parse(this->textBox2->Text);
	double H = System::Double::Parse(this->textBox3->Text);
	double Fl = System::Double::Parse(this->textBox4->Text);
	...
	double eta = System::Double::Parse(this->textBox11->Text);
	double myu = System::Double::Parse(this->textBox12->Text);
	//Microsoft::VisualBasic::Interaction::InputBox(L"Электрическая мощность светильника", L"Title", message = L"", 500, 500); Тут я попробовал использовать интеракивное окно из визуал бэейсика
	double W = 0.9 * Wt;
