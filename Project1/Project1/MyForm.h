...
private: void isEmptyTextBox(System::String^ Text) {
	if (Text=="") MessageBox::Show(this, "Заполните все поля!", "Ошибка ввода", MessageBoxButtons::OK, MessageBoxIcon::Error);
}


private: void inputValidation() {
	isEmptyTextBox(this->toolStripTextBox1->Text);
	isEmptyTextBox(this->textBox1->Text);
	isEmptyTextBox(this->textBox2->Text);
	isEmptyTextBox(this->textBox3->Text);
	isEmptyTextBox(this->textBox4->Text);
	isEmptyTextBox(this->textBox5->Text);
	isEmptyTextBox(this->textBox6->Text);
	isEmptyTextBox(this->textBox7->Text);
	isEmptyTextBox(this->textBox8->Text);
	isEmptyTextBox(this->textBox9->Text);
	isEmptyTextBox(this->textBox10->Text);
	isEmptyTextBox(this->textBox11->Text);
	isEmptyTextBox(this->textBox12->Text);
}
